...
void MyMesh::GenerateCircle(float a_fRadius, int a_nSubdivisions, vector3 a_v3Color)
{
	...
	*/
	...
	vector3 point1; //center of the circle
	vector3 point2; //point to be reused
	vector3 point3;// point to be added

	//set the center of the circle to be at (0,0)
	point1.x = 0;
	point1.y = 0;

	//calculate theta for a circle with this many subdivisions
	float theta = 360 / a_nSubdivisions;
	float theta2; //The theta value for point 2 of the triangle being added
	float theta3; // The theta value for point 3 of the triangle being added
	...
	for (int i = 0; i < a_nSubdivisions; i++) {
		...
		//calculate point 2
		point2.x = a_fRadius * sin(theta2 * PI / 180);
		point2.y = a_fRadius * cos(theta2 * PI / 180);

		//calculate point 3
		point3.x = a_fRadius * sin(theta3 * PI / 180);
		point3.y = a_fRadius * cos(theta3 * PI / 180);
